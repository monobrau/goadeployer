...
Write-Host "[INFO] Configuring WinRM on $(hostname)..." -ForegroundColor Green
Write-Host ""
...
Write-Host "  From Linux: winrs -r:http://$(hostname):5985 -u:Administrator -p:$Password hostname" -ForegroundColor White
